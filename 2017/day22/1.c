...
static void destroy_grid(bool ** const, size_t const);
static void print_grid(bool ** const, size_t const, size_t const, size_t const);
...
static void
print_grid(bool ** const g, size_t const row, size_t const col, size_t const sz)
{
	for (size_t i = 0; i < sz; i++) {
