...
static size_t
choose_next_recipe(char const * const,
		size_t const,
		size_t const);
...
main(int const argc, char const * const * const argv)
{
	...
	while (1) {
		...
		if (recipes[n_recipes-6] == 4 &&
				recipes[n_recipes-5] == 3 &&
				recipes[n_recipes-4] == 0 &&
				recipes[n_recipes-3] == 9 &&
				recipes[n_recipes-2] == 7 &&
		 	  recipes[n_recipes-1] == 1) {
			printf("%" PRIu64 "\n", total_recipes-6);
			break;
		}
		if (n_recipes < 7) {
		...
		if (recipes[n_recipes-7] == 4 &&
				recipes[n_recipes-6] == 3 &&
				recipes[n_recipes-5] == 0 &&
				recipes[n_recipes-4] == 9 &&
				recipes[n_recipes-3] == 7 &&
				recipes[n_recipes-2] == 1) {
			printf("%" PRIu64 "\n", total_recipes-7);
			break;
		}
	}
